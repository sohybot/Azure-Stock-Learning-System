...
# 📈 ASFM: AI 기반 주식 투자 교육 시뮬레이터

> AI가 만들어내는 가장 현실적인 주식 시장, 그리고 완벽한 학습 루프

ASFM은 행동경제학 기반 생성형 에이전트 사회를 활용하여  
실제 증권시장과 유사한 환경에서 투자 전략을 학습할 수 있도록 설계된  
...
## 2️⃣ 실시간 연속 복수 호가 매칭 엔진 (CDA Market Engine)

- 실제 거래소 구조와 동일한 CDA 매칭 시스템 구현
- Python Asyncio 기반 비동기 처리
- Time-Warp 시스템 (현실 2초 = 가상 1분)
- Human-in-the-Loop 구조 → 사용자 개입 시 가격 및 시장 반응 즉시 반영
